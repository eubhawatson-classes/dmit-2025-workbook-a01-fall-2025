/*
    INSERT is the command for the CREATE part of CRUD. It allows us to add record into a specified table (or row).

    The syntax looks something like this:

    INSERT INTO table_name (column_1, column_2, column_3 ...) VALUES (value1, value2, value 3 ...);
*/
...
-- But what if we wanted to enter multiple records at once? 
