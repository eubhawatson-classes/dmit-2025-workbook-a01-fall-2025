...
<p class="lead mb-5">The Happy Planet Index is a measure of sustainable well-being, ranking countries by how efficinetly they deliver long, happy lives using our limited environmental resources.</p>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) {
                // This method takes everything in a row (which is an array) and assigns each value to a variable with the column's name.
                extract($row);
