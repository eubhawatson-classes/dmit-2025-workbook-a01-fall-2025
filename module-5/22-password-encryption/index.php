...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    // Hash the first password as we normally would when the user registers for an account. (The default encryption algorithm is currently BCRYPT.)
  ...
  <body class="container">
    <main class="row justify-content-center my-5">
        <section class="col col-md-10 col-lg-8">
            ...
            <p class="lead">Enter a password to see how hashing works. Then, enter another to see if it matches the first.</p>
            ...
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <input type="submit" id="submit" name="submit" value="Hash & Compare" class="btn btn-primary">
            </form>
        </section>
    </main>
  </body>
